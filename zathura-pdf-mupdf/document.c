...
zathura_error_t pdf_document_open(zathura_document_t* document) {
  ...
  const char *css = 
      ...
      "@font-face { font-family: \"KaiTi\"; src: url(/home/blissful/fonts/collection/Chinese/KaiTi.ttf); }\n"
      "@page { font-family: \"EB Garamond\", KaiTi; line-height: 1.4; margin: 2em 6em; }\n"
      "body { font-family: \"EB Garamond\", KaiTi !important; }\n"
      "p { margin: 0.5em 0; }\n"
      "aside { display: block; margin: 1em; line-height: 1.3; }\n"
      "blockquote { display: block; margin: 1em; line-height: 1.3; }\n"
      ;
